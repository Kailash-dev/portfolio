  ...
  >
    ...
    <div className="relative z-10 flex flex-col items-center px-4 text-center text-white">
      ...
      <img
        src={profile.profileImage}
        alt="profile"
        className="w-24 h-24 sm:w-28 sm:h-28 rounded-full border-4 border-white shadow-lg mb-6 object-cover"
      />
      ...
      {/* Summary */}
      <p className="max-w-xl text-sm sm:text-base text-gray-400 mb-6 leading-relaxed">
        {profile.summary}
      </p>
