    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 sm:px-6">
        ...
        <img
          src={profile.profileImage}
          alt="Profile"
          className="w-24 h-24 sm:w-28 sm:h-28 rounded-full border-2 border-white shadow-lg mb-6 object-cover"
        />
        ...
        {/* Animated Subtitle */}
        <h2 className="mt-3 text-base sm:text-lg md:text-xl text-gray-300">
          <Typewriter
            words={profile.roles}
            loop
            cursor
        ...
        {/* Summary */}
        <p className="mt-4 max-w-xl text-sm sm:text-base text-gray-300">
          {profile.summary}
        </p>
